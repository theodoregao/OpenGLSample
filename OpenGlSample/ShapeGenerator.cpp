...
ShapeData ShapeGenerator::makeTriangle() {
	...
	ret.numVertices = sizeof(verts) / sizeof(verts[0]);
	ret.vertices = new Vertex[ret.numVertices];
	memcpy(ret.vertices, verts, sizeof(verts));

	GLushort indices[] = {0, 1, 2};
	ret.numIndices = sizeof(indices) / sizeof(indices[0]);
...
ShapeData ShapeGenerator::makeCube() {
	...
	ret.numVertices = sizeof(stackVerts) / sizeof(stackVerts[0]);
	ret.vertices = new Vertex[ret.numVertices];
	...
	ret.numIndices = sizeof(stackIndices) / sizeof(stackIndices[0]);
	ret.indices = new GLushort[ret.numIndices];
